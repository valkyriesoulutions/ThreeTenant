...
$webHostFolder = Join-Path $slnFolder "src/ThreeTenant.Web.Host"
$webPublicFolder = Join-Path $slnFolder "src/ThreeTenant.Web.Public"
...
docker rmi threetenantwebhost -f
...
docker rmi threetenantwebpublic -f
docker compose -f docker-compose.yml build
...
docker rmi threetenantwebangular -f
docker compose -f docker-compose.yml build
