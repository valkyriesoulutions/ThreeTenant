...
using ThreeTenant.DashboardCustomization.Definitions;
using ThreeTenant.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace ThreeTenant.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : ThreeTenantAppServiceBase, IDashboardCustomizationAppService
    {
