...
namespace ThreeTenant.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : ThreeTenantAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<ThreeTenantDbContext> _migrator;
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{ThreeTenantConsts.ConnectionStringName}", constring);
        }
