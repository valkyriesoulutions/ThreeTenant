...
using ThreeTenant.UiCustomization;
using ThreeTenant.Authorization.Delegation;
using ThreeTenant.Authorization.Users;
using Abp.Domain.Uow;
using Abp.Localization;
using ThreeTenant.Features;

namespace ThreeTenant.Sessions
{
    public class SessionAppService : ThreeTenantAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = ThreeTenantConsts.Currency,
                        CurrencySign = ThreeTenantConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = ThreeTenantConsts.AllowTenantsToChangeEmailSettings,
