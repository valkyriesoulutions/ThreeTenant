...
using ThreeTenant.DemoUiComponents.Dto;

namespace ThreeTenant.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : ThreeTenantAppServiceBase, IDemoUiComponentsAppService
    {
