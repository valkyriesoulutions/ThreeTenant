...
using ThreeTenant.DynamicEntityPropertyValues.Dto;

namespace ThreeTenant.DynamicEntityProperties
{
    [AbpAuthorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : ThreeTenantAppServiceBase, IDynamicEntityPropertyValueAppService
    {
