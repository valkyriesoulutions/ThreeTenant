...
{
    public class StripeGatewayManager : ThreeTenantServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "ThreeTenant";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + ThreeTenantConsts.Currency;
        }
