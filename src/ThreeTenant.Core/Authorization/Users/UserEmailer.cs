...
using ThreeTenant.Localization;
...
using ThreeTenant.Net.Emailing;
...
namespace ThreeTenant.Authorization.Users
{
    ...
    /// </summary>
    public class UserEmailer : ThreeTenantServiceBase, IUserEmailer, ITransientDependency
    {
        ...
        public async Task SendPasswordResetLinkAsync(User user, string link = null)
        {
            ...
            if (!link.IsNullOrEmpty())
            {
                ...
                var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours).ToString(ThreeTenantConsts.DateTimeOffsetFormat));
