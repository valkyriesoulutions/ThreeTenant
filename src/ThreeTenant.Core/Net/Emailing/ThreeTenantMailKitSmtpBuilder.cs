...
{
    public class ThreeTenantMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public ThreeTenantMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(ThreeTenantConsts.LocalizationSourceName, name);
        }
    }
}