...
namespace ThreeTenant.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : ThreeTenantServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("ThreeTenant", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
