(function () {
    let _addFromDifferentTenantModal = new app.ModalManager({
        viewUrl: abp.appPath + 'App/Chat/AddFromDifferentTenantModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/Chat/_AddFromDifferentTenantModal.js',
    ...
    app.modals.AddFriendModal.create = function (lookupOptions) {
        return new app.ModalManager({
            viewUrl: abp.appPath + 'App/Chat/AddFriendModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/Chat/_AddFriendModal.js',
