  ...
  app.modals.MySettingsModal = function () {
    ...
    this.init = function (modalManager) {
      ...
      let twoFactorModal = new app.ModalManager({
        ...
        scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/Profile/_TwoFactorAuthenticationModal.js',
      ...
      var viewRecoveryCodesModal = new app.ModalManager({
        ...
        scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/Profile/_ViewRecoveryCodesModal.js',
      ...
      var removeAuthenticatorModal = new app.ModalManager({
        ...
        scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/Profile/_RemoveAuthenticatorModal.js',
