...
using ThreeTenant.Authentication.TwoFactor.Google;
...
using ThreeTenant.Authorization.Impersonation;
using ThreeTenant.Authorization.Users;
using ThreeTenant.Configuration;
using ThreeTenant.Debugging;
using ThreeTenant.Identity;
using ThreeTenant.MultiTenancy;
using ThreeTenant.Net.Sms;
using ThreeTenant.Notifications;
using ThreeTenant.Web.Models.Account;
using ThreeTenant.Security;
using ThreeTenant.Security.Recaptcha;
using ThreeTenant.Sessions;
using ThreeTenant.Url;
using ThreeTenant.Web.Authentication.External;
using ThreeTenant.Web.Security.Recaptcha;
using ThreeTenant.Web.Session;
using ThreeTenant.Web.Views.Shared.Components.TenantChange;
using Abp.CachedUniqueKeys;
using Abp.AspNetCore.Mvc.Caching;
using Abp.HtmlSanitizer;
using ThreeTenant.Authorization.Users.Profile;
using ThreeTenant.Authorization.Users.Profile.Dto;
using Abp.Runtime.Security;
using SignInResult = Microsoft.AspNetCore.Identity.SignInResult;

namespace ThreeTenant.Web.Controllers
{
    public class AccountController : ThreeTenantControllerBase
    {
            ...
            string returnUrlHash = "", string ss = "")
        {
            ...
            if (loginResult.User.ShouldChangePasswordOnNextLogin)
            {
                ...
                var expireDate =
                    Uri.EscapeDataString(Clock.Now.AddHours(1).ToString(ThreeTenantConsts.DateTimeOffsetFormat));
