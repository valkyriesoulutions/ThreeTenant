...
using ThreeTenant.DynamicEntityProperties;
using ThreeTenant.DynamicEntityProperties.Dto;
using ThreeTenant.Web.Areas.App.Models.DynamicProperty;
using ThreeTenant.Web.Controllers;

namespace ThreeTenant.Web.Areas.App.Controllers
{
    [Area("App")]
    public class DynamicPropertyController : ThreeTenantControllerBase
    {
