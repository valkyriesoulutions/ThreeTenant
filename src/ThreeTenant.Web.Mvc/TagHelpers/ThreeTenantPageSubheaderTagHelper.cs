...
using ThreeTenant.UiCustomization.Dto;

namespace ThreeTenant.Web.TagHelpers
{
    ...
    public class ThreeTenantPageSubheaderTagHelper : TagHelper
    {
        ...
        public ThreeTenantPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
