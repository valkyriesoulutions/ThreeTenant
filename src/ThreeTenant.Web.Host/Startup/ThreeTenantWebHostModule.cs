...
using ThreeTenant.Web.Startup.ExternalLoginInfoProviders;
...
namespace ThreeTenant.Web.Startup
{
    ...
    public class ThreeTenantWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ThreeTenantWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ThreeTenantWebHostModule).GetAssembly());
        }
