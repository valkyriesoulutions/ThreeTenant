...
using ThreeTenant.Mobile.MAUI.Services.Account;
using ThreeTenant.Mobile.MAUI.Services.UI;
using Microsoft.JSInterop;
using ThreeTenant.Mobile.MAUI.Services.Tenants;

#if ANDROID
using ThreeTenant.Mobile.MAUI.Platforms.Android.HttpClient;
#endif

namespace ThreeTenant.Mobile.MAUI.Shared.Layout
{
...
#elif IOS
            var abpHttpClientFactory = new ThreeTenant.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
