...
namespace ThreeTenant.Core.Base
{
    public abstract class ThreeTenantQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected ThreeTenantQueryBase(string fieldName,
