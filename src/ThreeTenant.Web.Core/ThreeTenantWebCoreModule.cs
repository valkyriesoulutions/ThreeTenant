...
using ThreeTenant.Web.Authentication.JwtBearer;
using ThreeTenant.Web.Authentication.TwoFactor;
using ThreeTenant.Web.Chat.SignalR;
using ThreeTenant.Web.Common;
using ThreeTenant.Web.Configuration;
...
namespace ThreeTenant.Web
{
    [DependsOn(
        typeof(ThreeTenantApplicationModule),
        typeof(ThreeTenantEntityFrameworkCoreModule),
    ...
    public class ThreeTenantWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ThreeTenantWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(ThreeTenantApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ThreeTenantWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(ThreeTenantWebCoreModule).Assembly);
        }
