...
/// </summary>
public static class ThreeTenantJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, ThreeTenantAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
