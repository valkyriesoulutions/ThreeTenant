...
using ThreeTenant.Web.Public.Startup;
using ThreeTenant.Web.Session;
using ThreeTenant.Web.UiCustomization;

namespace ThreeTenant.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : ThreeTenantViewComponent
    {
