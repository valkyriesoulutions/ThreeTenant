...
namespace ThreeTenant.Migrations
{
    ...
    [Migration("20220516051930_Fix_Index_On_Subscription_Payment_Extension_Data")]
    partial class Fix_Index_On_Subscription_Payment_Extension_Data
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThreeTenant.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ThreeTenant.Authorization.Users.RecentPassword", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ThreeTenant.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ThreeTenant.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ThreeTenant.Authorization.Users.User", null)
                        .WithMany("Claims")
