...
{
    public class ThreeTenantDbContext : AbpZeroDbContext<Tenant, Role, User, ThreeTenantDbContext>
    {
        ...
        public ThreeTenantDbContext(DbContextOptions<ThreeTenantDbContext> options)
            : base(options)
        {
