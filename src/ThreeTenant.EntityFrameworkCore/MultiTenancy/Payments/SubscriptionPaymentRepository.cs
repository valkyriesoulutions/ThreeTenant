...
{
    public class SubscriptionPaymentRepository : ThreeTenantRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<ThreeTenantDbContext> dbContextProvider)
