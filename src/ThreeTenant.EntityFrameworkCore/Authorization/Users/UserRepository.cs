...
{
    public class UserRepository : ThreeTenantRepositoryBase<User, long>, IUserRepository
    {
        public UserRepository(IDbContextProvider<ThreeTenantDbContext> dbContextProvider)
