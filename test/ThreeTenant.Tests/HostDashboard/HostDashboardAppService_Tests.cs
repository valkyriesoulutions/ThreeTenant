...
using ThreeTenant.MultiTenancy.HostDashboard;
...
namespace ThreeTenant.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(ThreeTenantDbContext context, SubscriptionPayment subscriptionPayment)
        {
